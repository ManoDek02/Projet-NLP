...
class ChatRequestAPI(BaseModel):
    ...
    n_results: int = Field(default=5, ge=1, le=20, description="Number of similar conversations to retrieve")
    temperature: Optional[float] = Field(default=0.7, ge=0, le=2, description="LLM temperature")
    max_tokens: Optional[int] = Field(default=500, ge=1, le=2000, description="Maximum tokens to generate")
